	...
	public function widget($args, $instance)
	{
		...
		if ($query->have_posts()) :
			while ($query->have_posts()) :
				...
				$custom_text = eventpress_pro_genesis_get_custom_field('_event_text');
				$price       = eventpress_pro_genesis_get_custom_field('_event_price');
				$address     = eventpress_pro_genesis_get_custom_field('_event_address');
				$city        = eventpress_pro_genesis_get_custom_field('_event_city');
				$state       = eventpress_pro_genesis_get_custom_field('_event_state');
				$zip         = eventpress_pro_genesis_get_custom_field('_event_zip');

				$loop .= sprintf('<a href="%s">%s</a>', get_permalink(), eventpress_pro_genesis_get_image(array('size' => 'properties')));
